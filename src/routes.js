...
import allExam from './components/Exam/allExam.vue'
import stuExam from './components/Exam/stuExam.vue'
...
import electricModule from './components/General/electricModule.vue'
import waterModule from './components/General/waterModule.vue'
...
import Retirement from './components/Logistics/Retirement.vue'
import roomInfo from './components/Logistics/roomInfo.vue'
...
let routes = [
    ...
    },
    {
        ...
        children: [
            { path: '/allExam', component: allExam, name: '所有考试' },
            { path: '/stuExam', component: stuExam, name: '学生考试' },
            ...
            { path: '/classroomApp', component: classroomApp, name: '教室管理' },
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/electricModule', component: electricModule, name: '用电管理' },
            { path: '/waterModule', component: waterModule, name: '用水管理' },
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/Retirement', component: Retirement, name: '退宿管理' },
            { path: '/roomInfo', component: roomInfo, name: '房间信息' }
        ]
    },
    {
        path: '/',
