<template>
  <div>
    ...
    <el-table-column label="学号">
			<el-input v-model="id" placeholder="学号"></el-input>
		</el-table-column>
    ...
    <el-form-item label="生日">
		...
		<el-table-column label="身份证类型">
			<el-input v-model="idType" placeholder="身份证类型"></el-input>
		</el-table-column>
		<el-table-column label="身份证号">
			<el-input v-model="idNunber" placeholder="身份证号"></el-input>
		</el-table-column>
		<el-table-column label="自己电话">
			<el-input v-model="phone" placeholder="自己电话"></el-input>
		</el-table-column>	
		<el-table-column label="父母电话">
			<el-input v-model="parentPhone" placeholder="父母电话"></el-input>
		</el-table-column>
		<el-table-column label="民族">
			<el-input v-model="folk" placeholder="民族"></el-input>
		</el-table-column>
		<el-table-column label="政治面貌">政治面貌:
